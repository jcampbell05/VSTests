...
// Supress the unused method parameter warning.
#define OCLINT_SUPPRESS_UNUSED_METHOD_PARAMETER __attribute__((annotate("oclint:suppress[unused method parameter]")))
